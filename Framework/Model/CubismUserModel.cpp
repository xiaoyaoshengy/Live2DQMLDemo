...
//ACubismMotion* CubismUserModel::LoadExpression(QString filePath)
//{
//    return CubismExpressionMotion::Create(filePath);
//}
...
//void CubismUserModel::LoadPhysics(QString filePath)
//{
//    _physics = CubismPhysics::Create(filePath);
//}
...
void CubismUserModel::CreateRenderer(QOpenGLContext* context)
{
    if (_renderer)
    {
        DeleteRenderer();
    }
    _renderer = Rendering::CubismRenderer::Create(context);
