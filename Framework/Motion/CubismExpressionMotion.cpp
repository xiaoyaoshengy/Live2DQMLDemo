...
//CubismExpressionMotion* CubismExpressionMotion::Create(QString filePath)
//{
//    CubismExpressionMotion* expression = CSM_NEW CubismExpressionMotion();
//    expression->SetFadeInTime(0.0f);
//    expression->SetFadeOutTime(0.0f);
//
//    CubismExp3JsonParser json(filePath);
//    if (!json.IsAvailable())
//    {
//        expression->_parameters.PrepareCapacity(0);
//        return expression;
//    }
//
//    for (int i = 0; i < json.GetParametersCount(); i++)
//    {
//        const CubismIdHandle parameterId = CubismFramework::GetIdManager()->GetId(json.GetParameterId(i));
//        const csmFloat32 value = json.GetParameterValue(i);
//
//        ExpressionBlendType blendType;
//
//        if (json.GetParameterBlendMode(i).isEmpty() || json.GetParameterBlendMode(i) == QStringLiteral("Add"))
//        {
//            blendType = ExpressionBlendType_Add;
//        }
//        else if (json.GetParameterBlendMode(i) == QStringLiteral("Multiply"))
//        {
//            blendType = ExpressionBlendType_Multiply;
//        }
//        else if (json.GetParameterBlendMode(i) == QStringLiteral("Overwrite"))
//        {
//            blendType = ExpressionBlendType_Overwrite;
//        }
//        else
